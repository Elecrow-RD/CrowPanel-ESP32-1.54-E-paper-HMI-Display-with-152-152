...
{
  EPD_HW_RESET();
  EPD_ShowPicture(0, 0, 152, 152, gImage_menu, BLACK);
  EPD_Display(ImageBW);
  EPD_FastUpdate();
  EPD_DeepSleep();
...
{
  EPD_HW_RESET();
  EPD_ShowPicture(0, 0, 152, 152, gImage_menu1, BLACK);
  EPD_Display(ImageBW);
  EPD_FastUpdate();
  EPD_DeepSleep();
...
{
  EPD_HW_RESET();
  EPD_ShowPicture(0, 0, 152, 152, gImage_menu2, BLACK);
  EPD_Display(ImageBW);
  EPD_FastUpdate();
  EPD_DeepSleep();
...
void show_description(int show_pos)
{
  ...
  switch (show_pos)
  {
    case 0:
      //第一页介绍
      EPD_HW_RESET();
      EPD_ShowPicture(0, 0, 152, 152, gImage_description, BLACK);
      EPD_Display(ImageBW);
      EPD_FastUpdate();
      EPD_DeepSleep();
    ...
    case 1:
      EPD_HW_RESET();
      EPD_ShowPicture(0, 0, 152, 152, gImage_description1, BLACK);
      EPD_Display(ImageBW);
      EPD_FastUpdate();
      EPD_DeepSleep();
    ...
    case 2:
      EPD_HW_RESET();
      EPD_ShowPicture(0, 0, 152, 152, gImage_description2, BLACK);
      EPD_Display(ImageBW);
      EPD_FastUpdate();
      EPD_DeepSleep();
    ...
    case 3:
      EPD_HW_RESET();
      EPD_ShowPicture(0, 0, 152, 152, gImage_description3, BLACK);
      EPD_Display(ImageBW);
      EPD_FastUpdate();
      EPD_DeepSleep();
    ...
    case 4:
      EPD_HW_RESET();
      EPD_ShowPicture(0, 0, 152, 152, gImage_description4, BLACK);
      EPD_Display(ImageBW);
      EPD_FastUpdate();
      EPD_DeepSleep();
    ...
    case 5:
      EPD_HW_RESET();
      EPD_ShowPicture(0, 0, 152, 152, gImage_description5, BLACK);
      EPD_Display(ImageBW);
      EPD_FastUpdate();
      EPD_DeepSleep();
    ...
    case 6:
      EPD_HW_RESET();
      EPD_ShowPicture(0, 0, 152, 152, gImage_description6, BLACK);
      EPD_Display(ImageBW);
      EPD_FastUpdate();
      EPD_DeepSleep();
...
void show_image_example(int show_pos)
{
  ...
  switch (show_pos)
  {
    case 0:
      EPD_HW_RESET();
      EPD_ShowPicture(0, 0, 152, 152, gImage_image, BLACK);
      EPD_Display(ImageBW);
      EPD_FastUpdate();
      EPD_DeepSleep();
    ...
    case 1:
      EPD_HW_RESET();
      EPD_ShowPicture(0, 0, 152, 152, gImage_image1, BLACK);
      EPD_Display(ImageBW);
      EPD_FastUpdate();
      EPD_DeepSleep();
    ...
    case 2:
      EPD_HW_RESET();
      EPD_ShowPicture(0, 0, 152, 152, gImage_image2, BLACK);
      EPD_Display(ImageBW);
      EPD_FastUpdate();
      EPD_DeepSleep();
    ...
    case 3:
      EPD_HW_RESET();
      EPD_ShowPicture(0, 0, 152, 152, gImage_image3, BLACK);
      EPD_Display(ImageBW);
      EPD_FastUpdate();
      EPD_DeepSleep();
    ...
    case 4:
      EPD_HW_RESET();
      EPD_ShowPicture(0, 0, 152, 152, gImage_image4, BLACK);
      EPD_Display(ImageBW);
      EPD_FastUpdate();
      EPD_DeepSleep();
    ...
    case 5:
      EPD_HW_RESET();
      EPD_ShowPicture(0, 0, 152, 152, gImage_image5, BLACK);
      EPD_Display(ImageBW);
      EPD_FastUpdate();
      EPD_DeepSleep();
    ...
    case 6:
      EPD_HW_RESET();
      EPD_ShowPicture(0, 0, 152, 152, gImage_image6, BLACK);
      EPD_Display(ImageBW);
      EPD_FastUpdate();
      EPD_DeepSleep();
...
void show_scenario_example_pos(int show_pos)  //scenario 显示游标  坐标左右颠倒
{
  if (show_pos == 0)
  {
    slide_pos = 0;
  ...
  switch (show_pos)
  {
    case 0:
      EPD_HW_RESET();
      EPD_ShowPicture(30, 138, 90, 8, gImage_scenario_pos, BLACK);
      EPD_Display(ImageBW);
      EPD_FastUpdate();
      EPD_DeepSleep();
    ...
    case 1:
      EPD_HW_RESET();
      EPD_ShowPicture(30, 138, 90, 8, gImage_scenario_pos1, BLACK);
      EPD_Display(ImageBW);
      EPD_FastUpdate();
      EPD_DeepSleep();
    ...
    case 2:
      EPD_HW_RESET();
      EPD_ShowPicture(30, 138, 90, 8, gImage_scenario_pos2, BLACK);
      EPD_Display(ImageBW);
      EPD_FastUpdate();
      EPD_DeepSleep();
    ...
    case 3:
      EPD_HW_RESET();
      EPD_ShowPicture(30, 138, 90, 8, gImage_scenario_pos3, BLACK);
      EPD_Display(ImageBW);
      EPD_FastUpdate();
      EPD_DeepSleep();
    ...
    case 4:
      EPD_HW_RESET();
      EPD_ShowPicture(30, 138, 90, 8, gImage_scenario_pos4, BLACK);
      EPD_Display(ImageBW);
      EPD_FastUpdate();
      EPD_DeepSleep();
...
void show_scenario_example_ctl(int show_pos) //scenario 显示开关
{
  ...
  switch (show_pos)
  {
    case 0:
      ...
      {
        EPD_HW_RESET();
        EPD_ShowPicture(30, 6, 14, 56, gImage_scenario_ctl_on, BLACK);
        EPD_Display(ImageBW);
        EPD_FastUpdate();
        EPD_DeepSleep();
      ...
      else if (scenario_ctl == 1)
      {
        ...
        EPD_HW_RESET();
        EPD_ShowPicture(30, 6, 14, 56, gImage_scenario_ctl_off, BLACK);
        EPD_Display(ImageBW);
        EPD_FastUpdate();
        EPD_DeepSleep();
    ...
    case 1:
      ...
      {
        EPD_HW_RESET();
        EPD_ShowPicture(49, 6, 14, 56, gImage_scenario_ctl_on, BLACK);
        EPD_Display(ImageBW);
        EPD_FastUpdate();
        EPD_DeepSleep();
      ...
      {
        EPD_HW_RESET();
        EPD_ShowPicture(49, 6, 14, 56, gImage_scenario_ctl_off, BLACK);
        EPD_Display(ImageBW);
        EPD_FastUpdate();
        EPD_DeepSleep();
    ...
    case 2:
      ...
      {
        EPD_HW_RESET();
        EPD_ShowPicture(68, 6, 14, 56, gImage_scenario_ctl_on, BLACK);
        EPD_Display(ImageBW);
        EPD_FastUpdate();
        EPD_DeepSleep();
      ...
      {
        EPD_HW_RESET();
        EPD_ShowPicture(68, 6, 14, 56, gImage_scenario_ctl_off, BLACK);
        EPD_Display(ImageBW);
        EPD_FastUpdate();
        EPD_DeepSleep();
    ...
    case 3:
      ...
      {
        EPD_HW_RESET();
        EPD_ShowPicture(87, 6, 14, 56, gImage_scenario_ctl_on, BLACK);
        EPD_Display(ImageBW);
        EPD_FastUpdate();
        EPD_DeepSleep();
      ...
      {
        EPD_HW_RESET();
        EPD_ShowPicture(87, 6, 14, 56, gImage_scenario_ctl_off, BLACK);
        EPD_Display(ImageBW);
        EPD_FastUpdate();
        EPD_DeepSleep();
    ...
    case 4:
      ...
      {
        EPD_HW_RESET();
        EPD_ShowPicture(106, 6, 14, 56, gImage_scenario_ctl_on, BLACK);
        EPD_Display(ImageBW);
        EPD_FastUpdate();
        EPD_DeepSleep();
      ...
      {
        EPD_HW_RESET();
        EPD_ShowPicture(106, 6, 14, 56, gImage_scenario_ctl_off, BLACK);
        EPD_Display(ImageBW);
        EPD_FastUpdate();
        EPD_DeepSleep();
...
void setup()
{
  ...
  EPD_ShowPicture(0, 0, 152, 152, gImage_boot_setup, BLACK);
  EPD_Display(ImageBW);
  EPD_FastUpdate();
  EPD_DeepSleep();

  EPD_HW_RESET();
  EPD_ShowPicture(0, 0, 152, 152, gImage_boot_setup_1, BLACK);
  EPD_Display(ImageBW);
  EPD_FastUpdate();
  EPD_DeepSleep();
  
  EPD_HW_RESET();
  EPD_ShowPicture(0, 0, 152, 152, gImage_boot_setup_info, BLACK);
  EPD_Display(ImageBW);
  EPD_FastUpdate();
  EPD_DeepSleep();
...
void test_title()
{
  ...
  EPD_FastUpdate();
  EPD_Clear_R26H();
  EPD_ShowString(3, 62, "Test Program", 24, BLACK);
  EPD_Display(ImageBW);
  EPD_FastUpdate();
  EPD_DeepSleep();
      ...
      case 5:
        ...
        if (peg_pos == 1)
        {
          ...
          else if (slide_pos == 2)
          {
            ...
            EPD_HW_RESET();
            EPD_ShowPicture(0, 0, 152, 152, gImage_scenario_home, BLACK);
            EPD_Display(ImageBW);
            EPD_FastUpdate();
            EPD_DeepSleep();
